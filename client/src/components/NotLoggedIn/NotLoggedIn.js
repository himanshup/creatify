        ...
        <Container className="bg-transparent">
          ...
          <div className="text-center mt-3">
            <p className="lead">
              ...
              tracks/artists, or with the top 100 songs from Billboard. Search
              for an artist and we will find the top tracks based on that
              artist. You can also search for keywords and we will find the top
              50 matching playlists, along with the top 100 tracks across all 50
              playlists.
            </p>

            <p className="lead">
              To get started, login with Spotify. If you don't want to login,
              view pictures{" "}
              <a
            ...
            >
              <span className="p-4 text-uppercase btns">
                Login With Spotify
              </span>
            </a>
          </div>
